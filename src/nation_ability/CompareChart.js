...
function CompareChart(props) {
  ...
  useEffect(() => {
    ...
    svg
      ...
      .style(
        'transform',
        'translate(' + moveXaxis + 'px, ' + moveYaxisT + 'px)'
      )
    ...
    svg
      ...
      .style(
        'transform',
        'translate(' + moveXaxis + 'px, ' + moveYaxisS + 'px)'
      )
      .call(yAxis);
  ...
  let value =
    props.data[
      props.data.map((v) => v.Team === props.nations[0]).indexOf(true)
    ];
  ...
  value =
    props.data[
      props.data.map((v) => v.Team === props.nations[1]).indexOf(true)
    ];
